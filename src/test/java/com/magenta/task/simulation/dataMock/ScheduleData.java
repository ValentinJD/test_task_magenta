...
public class ScheduleData {
    ...
    static {
        SCHEDULE.setTimeGoToOutDC(LocalTime.of(9, 1)); // время выезда из распределительного центра
        SCHEDULE.setTimeToReturnInDC(LocalTime.of(14, 27)); // время возвращения в распределительный центр
    ...
    public static final int DRIVING_TIME_DC_POINT1 = 59;
    ...
    public static final int DRIVING_TIME_POINT1_POINT2 = 60; // мин
    ...
    public static final int DRIVING_TIME_POINT3_DC = 59; // мин
