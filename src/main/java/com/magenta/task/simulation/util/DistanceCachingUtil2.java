...
public class DistanceCachingUtil2 {
    ...
    public  double getDistanceInKiloMeters(PointInMap point1, PointInMap point2) {
    ...
    public  JsonNode getJsonNode(final String json) throws IOException, JSONException {
    ...
    public  Double getDistanceInKiloMeters(String json) {
